...
*/
$(function(){function t(){var t=$("#menu-item-edit-page"),n;t.length>0&&(n=$("#hasDropdownDiv"),n.hide(),$("#HasDropDown").click(function(){this.checked?n.show("slow"):n.hide("slow")}))}$.devOrg.Constants={registerForm:$("form.register-form"),userName:"UserName",email:"Email",phoneNumberSelector:"#Phone",slash:"/",validatorCommonUrl:"/Validator/",usernameValidationUrl:"/Validator/Username",emailAddressValidationUrl:"/Validator/Email",countryJsonUrl:"/Content/Scripts/Data/country-info-select-ready.json",timeZoneJsonUrl:"/Partials/GetTimeZone",languageJsonUrl:"/Partials/GetLanguage"};$.devOrg.Constants.registerForm.length>0&&($.devOrg.countryTimezonePhoneComponent.initialize($.devOrg.Constants.countryJsonUrl,$.devOrg.Constants.timeZoneJsonUrl,$.devOrg.Constants.languageJsonUrl,!0),$.devOrg.validateInputFromServer("#"+$.devOrg.Constants.userName,$.devOrg.Constants.usernameValidationUrl,$.devOrg.Constants.userName,!0,!1,3),$.devOrg.validateInputFromServer("#"+$.devOrg.Constants.email,$.devOrg.Constants.emailAddressValidationUrl,$.devOrg.Constants.email,!1,!1,4),$.devOrg.enterToNextTextBox(".register-form",!1),$("button.fillit").click(function(){$.devOrg.fillRegisterFieldsOnDemo()}),$.devOrg.bootstrapComboSelectbyFindingValue("select.country-combo","1"));$.devOrg.dynamicSelect.initialize();var n=$("table.bootstrap-table-do");n.length>0&&n.bootstrapTable();$("select.selectpicker").selectpicker();$.devOrg.bootstrapComboSelectIndex("select.selectpicker",0);$.devOrg.ratingMordernize();$.devOrg.bootstrapTabsMordernize(".make-it-tab");t();$("textarea.big-multiline").focus(function(){$(this).animate({height:"300px",width:"630px","max-width":"630px"},400)}).blur(function(){$(this).animate({height:"auto",width:"294px","max-width":"294px"},400)});$("textarea").elastic().trigger("update");$(".datetimepicker").datetimepicker({pickDate:!0,pickTime:!0,useMinutes:!0,useSeconds:!0,useCurrent:!0,minuteStepping:1,defaultDate:"",disabledDates:[],enabledDates:[],sideBySide:!0});$(".datepicker").datetimepicker({pickDate:!0,pickTime:!1,useMinutes:!1,useSeconds:!1,useCurrent:!0,minuteStepping:1,defaultDate:"",disabledDates:[],enabledDates:[],sideBySide:!0})});
